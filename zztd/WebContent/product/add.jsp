...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Product Add    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>product list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/product_add.action">
				  <div class="control-group">
				    <label class="control-label" for="inputName">name</label>
				    <div class="controls">
				      <input type="text" id="inputName" name="product.name">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDescribe">describe</label>
				    <div class="controls">
				      <input type="text" id="inputDescribe" name="product.describe">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMaxmoney">maxmoney</label>
				    <div class="controls">
				      <input type="text" id="inputMaxmoney" name="product.maxmoney">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMinmoney">minmoney</label>
				    <div class="controls">
				      <input type="text" id="inputMinmoney" name="product.minmoney">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMaxlimit">maxlimit</label>
				    <div class="controls">
				      <input type="text" id="inputMaxlimit" name="product.maxlimit">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMinlimit">minlimit</label>
				    <div class="controls">
				      <input type="text" id="inputMinlimit" name="product.minlimit">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputVerifytime">verifytime</label>
				    <div class="controls">
				      <input type="text" id="inputVerifytime" name="product.verifytime">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMaxrate">maxrate</label>
				    <div class="controls">
				      <input type="text" id="inputMaxrate" name="product.maxrate">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMinrate">minrate</label>
				    <div class="controls">
				      <input type="text" id="inputMinrate" name="product.minrate">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputTendertime">tendertime</label>
				    <div class="controls">
				      <input type="text" id="inputTendertime" name="product.tendertime">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputReplyway">replyway</label>
				    <div class="controls">
				      <input type="text" id="inputReplyway" name="product.replyway">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputFee">fee</label>
				    <div class="controls">
				      <input type="text" id="inputFee" name="product.fee">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
