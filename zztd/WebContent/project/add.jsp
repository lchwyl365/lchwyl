...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>Project Add    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>project list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/project_add.action">
				  <div class="control-group">
				    <label class="control-label" for="inputName">name</label>
				    <div class="controls">
				      <input type="text" id="inputName" name="project.name">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputMoney">money</label>
				    <div class="controls">
				      <input type="text" id="inputMoney" name="project.money">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputDeadline">deadline</label>
				    <div class="controls">
				      <input type="text" id="inputDeadline" name="project.deadline">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputRate">rate</label>
				    <div class="controls">
				      <input type="text" id="inputRate" name="project.rate">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
