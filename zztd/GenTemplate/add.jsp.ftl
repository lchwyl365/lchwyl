<#macro fieldInput fields>
	<#list fields as field>
				  <div class="control-group">
				    ...
				    <div class="controls">
				      <input type="text" id="input${field.name?cap_first}" name="${model.className?uncap_first}.${field.name}">
				    </div>
				  </div>
	</#list>
</#macro>
...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>${model.className} 添加    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>${model.className?uncap_first} list</a>
		    </legend>
		    	<form class="form-horizontal" action="${r"${contextPath}"}/front/${model.className?uncap_first}_add.action">
