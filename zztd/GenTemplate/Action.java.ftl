...
public class ${model.className}Action extends BaseAction {
	...
	public String delete(){
		result = ${model.className?uncap_first}Service.delete(${model.className?uncap_first}.getTbid());
		return "result-json";
	}
	
	public String intoUpdate(){
		${model.className?uncap_first} = ${model.className?uncap_first}Service.searchById(${model.className?uncap_first}.getTbid());
		return "intoUpdate";
	}
	
	public String update(){
		result = ${model.className?uncap_first}Service.update(${model.className?uncap_first});
		backurl = "front/${model.className?uncap_first}_intoUpdate.action?${model.className?uncap_first}.tbid="+${model.className?uncap_first}.getTbid();
		return "result-jsp";
	}
